...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_AMS_AS5600_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_REVOLUTE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AMS_AS5600, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_HID_PROTOCOL_CODE, 0);
